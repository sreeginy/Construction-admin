...
// validation
AddEditEmployeePopUp.propTypes = {
...
export default function AddEditEmployeePopUp(props) {
    const { data, onClose } = props;
    const [roleData, setRoleData] = React.useState(data);
    const { avatarUrl,id, name, position, bio, email, facebook } = roleData;
...
const AddSchema = yup.object().shape({
    ...
    position: yup.string().email("invalid email").required("required"),
