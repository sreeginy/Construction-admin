...
// validation
AddEditMaterialPopUp.propTypes = {
...
export default function AddEditMaterialPopUp(props) {
    const { data, onClose } = props;
    const [roleData, setRoleData] = React.useState(data);
    const { id, name, category, description, isVerified,projectName, status } = roleData;
